...
public sealed class ConcurrentVoiceClientCache : IVoiceClientCache
{
    ...
    public IReadOnlyCollection<ulong> Users => _users;
...
#pragma warning restore IDE0032 // Use auto property
    ...
    public JsonVoiceClientCache ToJsonModel()
    {
        return new()
        {
            ...
            UserSsrcs = _userSsrcs.ToDictionary(),
            SsrcUsers = _ssrcUsers.ToDictionary(),
        };
    }
    ...
    private sealed class ConcurrentHashSet<T> : IReadOnlyCollection<T> where T : notnull
    {
