...
#pragma warning restore CA2012 // Use ValueTasks correctly
    ...
    private protected ValueTask InvokeEventAsync<TRaw, T>(ImmutableList<Func<T, ValueTask>> handlers, TRaw rawData, Func<TRaw, T> dataFunc, [CallerArgumentExpression(nameof(handlers))] string handlersName = "")
    {
        int count = handlers.Count;
...
#pragma warning restore CA2012 // Use ValueTasks correctly
    ...
    private protected static ValueTask InvokeEventAsync<TClient, T>(ImmutableList<Func<T, ValueTask>> handlers, TClient client, T data, Action<TClient, T> updateCache, [CallerArgumentExpression(nameof(handlers))] string handlersName = "") where TClient : WebSocketClient
    {
        int count = handlers.Count;
...
#pragma warning restore CA2012 // Use ValueTasks correctly
    ...
    private protected static ValueTask InvokeEventAsync<TClient, TRaw, T>(ImmutableList<Func<T, ValueTask>> handlers, TClient client, TRaw rawData, Func<TRaw, T> dataFunc, Action<TClient, TRaw> updateCache, [CallerArgumentExpression(nameof(handlers))] string handlersName = "") where TClient : WebSocketClient
    {
        int count = handlers.Count;
...
#pragma warning restore CA2012 // Use ValueTasks correctly
    ...
    private protected ValueTask InvokeEventWithDisposalAsync<TRaw, T>(ImmutableList<Func<T, ValueTask>> handlers, TRaw rawData, Func<TRaw, T> dataFunc, Action<T> disposeData, [CallerArgumentExpression(nameof(handlers))] string handlersName = "")
    {
        int count = handlers.Count;
